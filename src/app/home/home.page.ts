...
export class HomePage implements OnInit {
  ...
  verifyEmail() {
    ...
    this.fireDynamicLinks.onDynamicLink().subscribe(
      (res: any) => {
        console.log(res);
        ...
        // });
        this.controllerService.showAlert(
          "Success",
          `Link intercepted and response is ${res}`
        );
      },
      (err: any) => {
        this.controllerService.showAlert(
          "Error",
          `Error intercepting link due to: ${err}`
        );
        ...
        this.androidPermissions
          ...
          .then(
            ...
            err => {
              ...
              alert(
                "requestPermission Error requesting location permissions" + err
              );
            }
          );
      }
  ...
  askToTurnOnGPS() {
    this.locationAccuracy
      ...
      .then(
        ...
        err =>
          alert("Error requesting location permissions" + JSON.stringify(err))
      );
  }
