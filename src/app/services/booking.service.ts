...
export class BookingService {
  ...
  createBooking(placeBookedID, placeBookedName) {
    ...
    return new Promise<any>((resolve, reject) => {
      this.bookingCollection.add({
        ...
        .then(res => {
          this.showAlert('Booked', `You have booked ${placeBookedName} successfully! and your booking id is ${uniqueBookingID}`);
          resolve(res);
        }, err => {
  ...
  bookPlace(placeId: string) {
      ...
      return new Promise<any>((resolve, reject) => {
        return this.afStore
          ...
          .then(res => {
            ...
            this.showAlert('Booked', `You have booked ${placeId} successfully! and your unique id is ${this.uniqueId}`);
            resolve(res);
    ...
    this.showAlert('Unsuccesful', 'The seats are all occupied! Try our other rooms.');
  }
